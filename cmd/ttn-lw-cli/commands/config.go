...
type RetryConfig struct {
	Max            uint          `name:"max" yaml:"max" description:"Maximum amount of times that a request can be attempted"`
	...
	EnableMetatada bool          `name:"enable_metadata" ymal:"enable_metadata" description:"Use request response metadata to calculate timeout between retry attempts"`
	Jitter         float64       `name:"jitter" yaml:"jitter" description:"Fraction that creates a deviation of the timeout used between retry attempts. Disables if the value is zero"`
}
